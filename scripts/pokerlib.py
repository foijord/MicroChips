...
class SevenEval:
    def __init__(self):
        self.ranks = [int(rank) for rank in open("../data/ranks_7.dat", "r")]
        self.flushes = [int(flush) for flush in open("../data/flushes_7.dat", "r")]
        self.flushcheck = [int(flushcheck) for flushcheck in open("../data/flushcheck_7.dat", "r")]
