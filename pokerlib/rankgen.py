...
def generate_5_card_ranks():
    ...
    ranks_5 = open("ranks_5.dat", "w+")
    for i in ranks:
        ranks_5.write("%i\n" % i)

    flushes_5 = open("flushes_5.dat", "w+")
    for i in flushes:
        flushes_5.write("%i\n" % i)
...
def generate_7_card_ranks():
        ...
        ranks_7 = open("ranks_7.dat", "w+")
        for i in ranks:
            ranks_7.write("%i\n" % i)

        flushes_7 = open("flushes_7.dat", "w+")
        for i in flushes:
            flushes_7.write("%i\n" % i)

        flushcheck_7 = open("flushcheck_7.dat", "w+")
        for i in flushcheck:
            flushcheck_7.write("%i\n" % i)
